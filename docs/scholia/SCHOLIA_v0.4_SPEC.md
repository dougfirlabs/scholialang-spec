...
- XML-shaped tags (a design choice that independently converged with a practitioner finding from within Anthropic, reported by Simon Willison, that HTML/XML-shaped tags work well for LLM memory)
